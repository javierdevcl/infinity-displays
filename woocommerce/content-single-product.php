...
<div class="bg-secondary/30 border-b border-border">
    <div class="container mx-auto px-4 py-3">
        <?php woocommerce_breadcrumb(array(
            'delimiter' => '<svg class="w-4 h-4 text-muted-foreground mx-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>',
            'wrap_before' => '<nav class="flex items-center text-sm flex-wrap">',
            'wrap_after' => '</nav>',
            'before' => '<span class="text-muted-foreground hover:text-primary whitespace-nowrap">',
            'after' => '</span>',
        )); ?>
    </div>
</div>
        ...
        <div>
            ...
            <div id="product-action-buttons" class="grid grid-cols-1 gap-3 mb-8">
                ...
                <form class="cart" method="post" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="single_add_to_cart_button button alt inline-flex items-center justify-center w-full px-6 py-4 text-base font-semibold bg-primary text-primary-foreground hover:bg-primary/90 rounded-lg transition-colors">
                ...
                <a href="#" class="quote-whatsapp inline-flex items-center justify-center w-full px-6 py-4 text-base font-semibold border-2 border-green-500 text-green-600 hover:bg-green-50 rounded-lg transition-colors" data-product-id="<?php echo $product->get_id(); ?>">
