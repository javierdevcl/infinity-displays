<?php
/**
 * The template for displaying product content within category loops
 * Now using the same design as homepage products
 *
...
<div <?php wc_product_class('group bg-white rounded-lg border border-border/50 overflow-hidden transition-all duration-300 hover:border-primary/50 hover:shadow-lg', $product); ?>>
    ...
    <div class="p-3">
        ...
        <div class="flex gap-2">
            <button onclick="openQuoteModal(); return false;" class="infinity-quote-btn flex-1 inline-flex items-center justify-center px-3 py-2 text-xs font-medium border border-gray-300 text-gray-700 hover:bg-gray-100 rounded-md transition-colors">
