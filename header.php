            ...
            <div class="hidden md:flex items-center justify-between gap-4 h-20 py-3">
                ...
                <div class="flex items-center gap-3 flex-shrink-0">
                    ...
                    <button onclick="openSideCart()" class="relative p-2 text-gray-700 hover:text-primary transition-colors" aria-label="Abrir carrito">
                        ...
                        <?php $cart_count = WC()->cart->get_cart_contents_count(); ?><span class="infinity-cart-badge infinity-cart-badge-desktop absolute top-0 right-0 bg-red-500 text-white text-[10px] font-bold rounded-full min-w-[18px] h-[18px] flex items-center justify-center leading-none<?php echo $cart_count > 0 ? '' : ' hidden'; ?>"><?php echo $cart_count; ?></span>
                    </button>
            ...
            <div class="md:hidden flex items-center justify-between h-16 py-2">
                ...
                <div class="flex items-center -mr-2">
                    ...
                    <button onclick="openSideCart()" class="relative p-2 text-gray-700 hover:text-primary transition-colors" aria-label="Abrir carrito">
                        ...
                        <?php $cart_count_mobile = WC()->cart->get_cart_contents_count(); ?><span class="infinity-cart-badge infinity-cart-badge-mobile absolute top-0.5 right-0.5 bg-red-500 text-white text-[9px] font-bold rounded-full min-w-[16px] h-[16px] flex items-center justify-center leading-none<?php echo $cart_count_mobile > 0 ? '' : ' hidden'; ?>"><?php echo $cart_count_mobile; ?></span>
                    </button>
                </div>
            </div>
        </div>
