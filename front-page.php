...
<section class="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 overflow-hidden">
    ...
    <div class="container mx-auto px-4 py-6 lg:py-10">
        ...
        <div class="hero-slider relative" data-slide-count="<?php echo $slide_count; ?>">
                ...
                <div class="hero-slide <?php echo $index === 0 ? 'active' : ''; ?>" data-index="<?php echo $index; ?>">
                    <div class="flex flex-col lg:flex-row items-center gap-6 lg:gap-10">
                        ...
                        <div class="flex-1 z-10 text-center lg:text-left order-2 lg:order-1">
                            ...
                            <span class="inline-block px-3 py-1 bg-primary text-white rounded-full text-xs font-semibold mb-3 uppercase tracking-wide">
                                <?php echo esc_html($slide['category']); ?>
                            </span>
                            <?php endif; ?>

                            <h2 class="text-xl lg:text-3xl font-display font-bold text-white mb-3 leading-tight">
                                <?php echo esc_html($slide['name']); ?>
                            </h2>

                            <!-- Feature highlights -->
                            <div class="flex flex-wrap justify-center lg:justify-start gap-3 mb-4 text-sm text-gray-300">
                            ...
                            <div class="flex items-center justify-center lg:justify-start gap-3 mb-5">
                                <span class="text-gray-400 text-sm">Desde</span>
                                <span class="text-2xl lg:text-3xl font-bold text-white">$<?php echo number_format($slide['price'], 0, ',', '.'); ?></span>
                            </div>

                            <div class="flex flex-col sm:flex-row items-center lg:items-start gap-3">
                                <a href="<?php echo esc_url($slide['link']); ?>" class="w-full sm:w-auto inline-flex items-center justify-center px-5 py-2.5 bg-primary text-white font-semibold rounded-lg hover:bg-primary/90 transition-all hover:shadow-lg hover:shadow-primary/25">
                                ...
                                <a href="https://wa.me/56942057591?text=<?php echo urlencode('Hola, me interesa el producto: ' . $slide['name']); ?>" target="_blank" class="w-full sm:w-auto inline-flex items-center justify-center px-5 py-2.5 bg-green-500 text-white font-semibold rounded-lg hover:bg-green-600 transition-colors">
                        ...
                        <div class="flex-shrink-0 order-1 lg:order-2">
                            <a href="<?php echo esc_url($slide['link']); ?>" class="block">
                                <div class="relative bg-white rounded-2xl shadow-2xl p-4 w-64 h-64 lg:w-72 lg:h-72 mx-auto overflow-hidden group">
                                    <?php if ($slide['image']): ?>
            ...
            <!-- Navigation Arrows -->
            <button class="hero-prev absolute left-0 top-1/2 -translate-y-1/2 w-9 h-9 bg-white/10 hover:bg-white/20 rounded-full flex items-center justify-center text-white transition-colors z-20 hidden lg:flex">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                </svg>
            </button>
            <button class="hero-next absolute right-0 top-1/2 -translate-y-1/2 w-9 h-9 bg-white/10 hover:bg-white/20 rounded-full flex items-center justify-center text-white transition-colors z-20 hidden lg:flex">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Dots Navigation -->
            <div class="hero-dots flex justify-center gap-2 mt-5">
                <?php for ($i = 0; $i < $slide_count; $i++): ?>
                <button class="hero-dot w-2 h-2 rounded-full transition-all <?php echo $i === 0 ? 'bg-primary w-6' : 'bg-white/30 hover:bg-white/50'; ?>" data-index="<?php echo $i; ?>"></button>
                <?php endfor; ?>
            </div>
            <?php endif; ?>
        </div>
